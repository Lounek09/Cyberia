...
public static class EffectFactory
{
    ...
    private static readonly FrozenDictionary<int, Func<int, EffectParameters, int, int, CriteriaReadOnlyCollection, bool, EffectArea, IEffect>> s_factories =
        new Dictionary<int, Func<int, EffectParameters, int, int, CriteriaReadOnlyCollection, bool, EffectArea, IEffect>>()
        {
            ...
            { 101, CharacterActionPointsLostTargetEffect.Create },
            ...
            { 170, CharacterLifePointsWinInRpEffect.Create },
            ...
            { 187, CharacterAlignmentRankSetEffect.Create },
            ...
            { 195, CharacterInventoryLoseKamasEffect.Create },
            ...
            { 231, CharacterEnergyPointsLoseEffect.Create },
            ...
            { 2051, CharacterGainLevelEffect.Create },
            { 2100, CharacterActionPointsLostEffect.Create },
