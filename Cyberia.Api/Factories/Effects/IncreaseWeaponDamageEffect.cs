...
namespace Cyberia.Api.Factories.Effects
{
    public sealed class IncreaseWeaponDamageEffect : BasicEffect
    {
        ...
        public IncreaseWeaponDamageEffect(int effectId, EffectParameters parameters, int duration, int probability, Area area) : 
        ...
        public static new IncreaseWeaponDamageEffect Create(int effectId, EffectParameters parameters, int duration, int probability, Area area)
        {
