...
namespace Cyberia.Api.Factories.Effects
{
    public sealed class SummonMonsterEffect : BasicEffect
    {
        ...
        public SummonMonsterEffect(int effectId, EffectParameters parameters, int duration, int probability, Area area) : 
        ...
        public static new SummonMonsterEffect Create(int effectId, EffectParameters parameters, int duration, int probability, Area area)
        {
