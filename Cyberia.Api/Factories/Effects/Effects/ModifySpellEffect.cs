...
namespace Cyberia.Api.Factories.Effects
{
    public sealed record ModifySpellEffect : Effect, IEffect<ModifySpellEffect>
    {
        ...
        private ModifySpellEffect(int effectId, int duration, int probability, List<ICriteriaElement> criteria, EffectArea effectArea, int spellId, int value) :
        ...
        public static ModifySpellEffect Create(int effectId, EffectParameters parameters, int duration, int probability, List<ICriteriaElement> criteria, EffectArea effectArea)
        {
