...
public sealed record CharacterTeleportToFightStartPosEffect : ParameterlessEffect, IEffect<CharacterTeleportToFightStartPosEffect>
{
    ...
    public static CharacterTeleportToFightStartPosEffect Create(int effectId, EffectParameters parameters, int duration, int probability, CriteriaCollection criteria, EffectArea effectArea)
    {
