...
public sealed record ItemLivingMoodEffect : Effect, IEffect<ItemLivingMoodEffect>
{
    ...
    public static ItemLivingMoodEffect Create(int effectId, EffectParameters parameters, int duration, int probability, CriteriaCollection criteria, EffectArea effectArea)
    {
