...
public sealed record AddMonsterToFightEffect : Effect, IEffect<AddMonsterToFightEffect>
{
    ...
    public static AddMonsterToFightEffect Create(int effectId, EffectParameters parameters, int duration, int probability, CriteriaCollection criteria, EffectArea effectArea)
    {
