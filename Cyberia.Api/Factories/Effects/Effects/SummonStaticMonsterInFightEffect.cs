...
namespace Cyberia.Api.Factories.Effects
{
    public sealed record SummonStaticMonsterInFightEffect : Effect, IEffect<SummonStaticMonsterInFightEffect>
    {
        ...
        private SummonStaticMonsterInFightEffect(int effectId, int duration, int probability, List<ICriteriaElement> criteria, EffectArea effectArea, int monsterId, int grade) :
        ...
        public static SummonStaticMonsterInFightEffect Create(int effectId, EffectParameters parameters, int duration, int probability, List<ICriteriaElement> criteria, EffectArea effectArea)
        {
