...
namespace Cyberia.Api.Factories.Effects
{
    public sealed record GlyphSpellEffect : Effect, IEffect<GlyphSpellEffect>
    {
        ...
        private GlyphSpellEffect(int effectId, int duration, int probability, CriteriaCollection criteria, EffectArea effectArea, int spellId, int level) :
        ...
        public static GlyphSpellEffect Create(int effectId, EffectParameters parameters, int duration, int probability, CriteriaCollection criteria, EffectArea effectArea)
        {
