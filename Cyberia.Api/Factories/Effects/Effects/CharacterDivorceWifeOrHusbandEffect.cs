...
public sealed record CharacterDivorceWifeOrHusbandEffect : ParameterlessEffect, IEffect<CharacterDivorceWifeOrHusbandEffect>
{
    ...
    public static CharacterDivorceWifeOrHusbandEffect Create(int effectId, EffectParameters parameters, int duration, int probability, CriteriaCollection criteria, EffectArea effectArea)
    {
