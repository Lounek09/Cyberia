...
public sealed record CharacterAddCostToActionEffect : ParameterlessEffect, IEffect<CharacterAddCostToActionEffect>
{
    ...
    public static CharacterAddCostToActionEffect Create(int effectId, EffectParameters parameters, int duration, int probability, CriteriaCollection criteria, EffectArea effectArea)
    {
