...
public sealed record NoopEffect : ParameterlessEffect, IEffect<NoopEffect>
{
    ...
    public static NoopEffect Create(int effectId, EffectParameters parameters, int duration, int probability, CriteriaCollection criteria, EffectArea effectArea)
    {
