...
public sealed record ThrowCarriedCaracterEffect : ParameterlessEffect, IEffect<ThrowCarriedCaracterEffect>
{
    ...
    public static ThrowCarriedCaracterEffect Create(int effectId, EffectParameters parameters, int duration, int probability, CriteriaCollection criteria, EffectArea effectArea)
    {
