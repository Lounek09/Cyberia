...
public sealed record RideCertificateValidityEffect : Effect, IEffect<RideCertificateValidityEffect>
{
    ...
    public static RideCertificateValidityEffect Create(int effectId, EffectParameters parameters, int duration, int probability, CriteriaCollection criteria, EffectArea effectArea)
    {
