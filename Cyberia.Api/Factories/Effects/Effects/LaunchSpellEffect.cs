...
namespace Cyberia.Api.Factories.Effects
{
    public sealed record LaunchSpellEffect : Effect, IEffect<LaunchSpellEffect>
    {
        ...
        private LaunchSpellEffect(int effectId, int duration, int probability, List<ICriteriaElement> criteria, EffectArea effectArea, int spellId, int level) :
        ...
        public static LaunchSpellEffect Create(int effectId, EffectParameters parameters, int duration, int probability, List<ICriteriaElement> criteria, EffectArea effectArea)
        {
