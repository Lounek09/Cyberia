...
public sealed record SetOwnerEffect : Effect, IEffect<SetOwnerEffect>
{
    ...
    public static SetOwnerEffect Create(int effectId, EffectParameters parameters, int duration, int probability, CriteriaCollection criteria, EffectArea effectArea)
    {
