...
public sealed record ItemTeleportEffect : Effect, IEffect<ItemTeleportEffect>
{
    public int MapId { get; init; }
    public int Cell { get; init; }

    private ItemTeleportEffect(int effectId, int duration, int probability, CriteriaCollection criteria, EffectArea effectArea, int mapId, int cell)
    ...
    public static ItemTeleportEffect Create(int effectId, EffectParameters parameters, int duration, int probability, CriteriaCollection criteria, EffectArea effectArea)
    {
