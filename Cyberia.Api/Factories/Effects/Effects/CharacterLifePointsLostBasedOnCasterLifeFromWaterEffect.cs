...
public sealed record CharacterLifePointsLostBasedOnCasterLifeFromWaterEffect : MinMaxEffect, IEffect<CharacterLifePointsLostBasedOnCasterLifeFromWaterEffect>
{
    ...
    public static CharacterLifePointsLostBasedOnCasterLifeFromWaterEffect Create(int effectId, EffectParameters parameters, int duration, int probability, CriteriaCollection criteria, EffectArea effectArea)
    {
