...
public sealed record CharacterDeboostPhysicalReductionEffect : MinMaxEffect, IEffect<CharacterDeboostPhysicalReductionEffect>
{
    ...
    public static CharacterDeboostPhysicalReductionEffect Create(int effectId, EffectParameters parameters, int duration, int probability, CriteriaCollection criteria, EffectArea effectArea)
    {
