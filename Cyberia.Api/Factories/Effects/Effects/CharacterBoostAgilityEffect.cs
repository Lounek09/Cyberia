...
public sealed record CharacterBoostAgilityEffect : MinMaxEffect, IEffect<CharacterBoostAgilityEffect>
{
    private CharacterBoostAgilityEffect(int effectId, int duration, int probability, CriteriaCollection criteria, EffectArea effectArea, int min, int max)
