...
public sealed record RideDetailsEffect : ParameterlessEffect, IEffect<RideDetailsEffect>
{
    private RideDetailsEffect(int effectId, int duration, int probability, CriteriaCollection criteria, EffectArea effectArea)
