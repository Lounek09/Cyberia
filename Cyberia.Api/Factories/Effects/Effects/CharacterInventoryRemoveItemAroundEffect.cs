...
public sealed record CharacterInventoryRemoveItemAroundEffect : Effect, IEffect<CharacterInventoryRemoveItemAroundEffect>
{
    ...
    private CharacterInventoryRemoveItemAroundEffect(int effectId, int duration, int probability, CriteriaCollection criteria, EffectArea effectArea, int itemId, int qte)
