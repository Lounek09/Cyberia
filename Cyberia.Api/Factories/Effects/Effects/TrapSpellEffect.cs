...
namespace Cyberia.Api.Factories.Effects
{
    public sealed record TrapSpellEffect : Effect, IEffect<TrapSpellEffect>
    {
        ...
        private TrapSpellEffect(int effectId, int duration, int probability, List<ICriteriaElement> criteria, EffectArea effectArea, int spellId, int level) :
        ...
        public static TrapSpellEffect Create(int effectId, EffectParameters parameters, int duration, int probability, List<ICriteriaElement> criteria, EffectArea effectArea)
        {
