...
namespace Cyberia.Api.Factories.Effects
{
    public sealed class TrapSpellEffect : BasicEffect
    {
        ...
        public TrapSpellEffect(int effectId, EffectParameters parameters, int duration, int probability, Area area) : 
        ...
        public static new TrapSpellEffect Create(int effectId, EffectParameters parameters, int duration, int probability, Area area)
        {
