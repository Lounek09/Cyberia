    ...
    : MinMaxEffect, IEffect
{
    ...
    internal static CharacterInventoryGainKamasEffect Create(int effectId, EffectParameters parameters, int duration, int probability, CriteriaReadOnlyCollection criteria, EffectArea effectArea)
    {
