...
public sealed record CharacterDeboostAirElementPercentEffect : MinMaxEffect
{
    ...
    internal static CharacterDeboostAirElementPercentEffect Create(int effectId, EffectParameters parameters, int duration, int probability, CriteriaReadOnlyCollection criteria, EffectArea effectArea)
    {
