...
public sealed record CharacterLearnJobEffect
    : Effect, IEffect
{
    ...
    internal static CharacterLearnJobEffect Create(int effectId, EffectParameters parameters, int duration, int probability, CriteriaCollection criteria, EffectArea effectArea)
    {
