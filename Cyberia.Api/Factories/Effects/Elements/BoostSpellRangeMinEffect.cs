    ...
    : SpellModifierEffect, IEffect
{
    ...
    internal static BoostSpellRangeMinEffect Create(int effectId, EffectParameters parameters, int duration, int probability, CriteriaCollection criteria, EffectArea effectArea)
    {
