...
public sealed record BoostSpellRangeMinEffect : SpellModifierEffect
{
    ...
    internal static BoostSpellRangeMinEffect Create(int effectId, EffectParameters parameters, int duration, int probability, CriteriaReadOnlyCollection criteria, EffectArea effectArea)
    {
