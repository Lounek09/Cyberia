    ...
    : MinMaxEffect, IEffect
{
    ...
    internal static CharacterLifePointsLostBasedOnCasterLifeFromWaterEffect Create(int effectId, EffectParameters parameters, int duration, int probability, CriteriaCollection criteria, EffectArea effectArea)
    {
