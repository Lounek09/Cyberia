    ...
    : ParameterlessEffect, IEffect
{
    ...
    internal static ThrowCarriedCaracterEffect Create(int effectId, EffectParameters _, int duration, int probability, CriteriaCollection criteria, EffectArea effectArea)
    {
