...
public sealed record CharacterReflectorUnboostedEffect
    : MinMaxEffect, IEffect, IRuneGeneratorEffect
{
    ...
    internal static CharacterReflectorUnboostedEffect Create(int effectId, EffectParameters parameters, int duration, int probability, CriteriaCollection criteria, EffectArea effectArea)
    {
