...
public sealed record SeekTargetEffect
    : Effect, IEffect
{
    ...
    internal static SeekTargetEffect Create(int effectId, EffectParameters parameters, int duration, int probability, CriteriaCollection criteria, EffectArea effectArea)
    {
