...
public sealed record CharacterPushEffect
    : Effect, IEffect
{
    ...
    internal static CharacterPushEffect Create(int effectId, EffectParameters parameters, int duration, int probability, CriteriaCollection criteria, EffectArea effectArea)
    {
