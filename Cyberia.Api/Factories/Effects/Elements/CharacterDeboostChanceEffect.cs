...
public sealed record CharacterDeboostChanceEffect : MinMaxEffect
{
    ...
    internal static CharacterDeboostChanceEffect Create(int effectId, EffectParameters parameters, int duration, int probability, CriteriaReadOnlyCollection criteria, EffectArea effectArea)
    {
