    ...
    : MinMaxEffect, IEffect
{
    ...
    internal static CharacterGainVitalityEffect Create(int effectId, EffectParameters parameters, int duration, int probability, CriteriaReadOnlyCollection criteria, EffectArea effectArea)
    {
