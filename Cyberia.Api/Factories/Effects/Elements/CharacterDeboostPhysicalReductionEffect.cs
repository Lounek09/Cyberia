    ...
    : MinMaxEffect, IEffect
{
    ...
    internal static CharacterDeboostPhysicalReductionEffect Create(int effectId, EffectParameters parameters, int duration, int probability, CriteriaCollection criteria, EffectArea effectArea)
    {
