...
public sealed record SummonStaticCreatureEffect
    : Effect, IEffect
{
    ...
    internal static SummonStaticCreatureEffect Create(int effectId, EffectParameters parameters, int duration, int probability, CriteriaCollection criteria, EffectArea effectArea)
    {
