...
public sealed record FightAddTrapCastingSpellEffect
    : TrapEffect, IEffect
{
    ...
    internal static FightAddTrapCastingSpellEffect Create(int effectId, EffectParameters parameters, int duration, int probability, CriteriaCollection criteria, EffectArea effectArea)
    {
