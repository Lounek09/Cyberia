...
public sealed record ItemCeremonialChangeDurabilityEffect
    : Effect, IEffect
{
    ...
    internal static ItemCeremonialChangeDurabilityEffect Create(int effectId, EffectParameters parameters, int duration, int probability, CriteriaCollection criteria, EffectArea effectArea)
    {
