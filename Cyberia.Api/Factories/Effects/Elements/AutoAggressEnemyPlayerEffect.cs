...
public sealed record AutoAggressEnemyPlayerEffect
    : Effect, IEffect
{
    ...
    internal static AutoAggressEnemyPlayerEffect Create(int effectId, EffectParameters parameters, int duration, int probability, CriteriaCollection criteria, EffectArea effectArea)
    {
