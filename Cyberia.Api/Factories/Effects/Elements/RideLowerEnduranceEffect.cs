    ...
    : ParameterlessEffect, IEffect
{
    ...
    internal static RideLowerEnduranceEffect Create(int effectId, EffectParameters _, int duration, int probability, CriteriaCollection criteria, EffectArea effectArea)
    {
