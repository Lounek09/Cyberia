...
{
    public Rune Rune => Rune.PiPer;

    private CharacterBoostTrapPercentEffect(int id, int min, int max)
        : base(id, min, max) { }

    internal static CharacterBoostTrapPercentEffect Create(int effectId, EffectParameters parameters)
    {
