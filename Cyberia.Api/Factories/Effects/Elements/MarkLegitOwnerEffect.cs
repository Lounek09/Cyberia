...
public sealed record MarkLegitOwnerEffect
    : Effect, IEffect
{
    ...
    internal static MarkLegitOwnerEffect Create(int effectId, EffectParameters parameters, int duration, int probability, CriteriaCollection criteria, EffectArea effectArea)
    {
