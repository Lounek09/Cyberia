...
public sealed record CharacterDispellSpellEffect
    : Effect, IEffect
{
    ...
    internal static CharacterDispellSpellEffect Create(int effectId, EffectParameters parameters, int duration, int probability, CriteriaCollection criteria, EffectArea effectArea)
    {
