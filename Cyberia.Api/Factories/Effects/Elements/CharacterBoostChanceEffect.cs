...
{
    public Rune Rune => Rune.Cha;

    private CharacterBoostChanceEffect(int id, int duration, int probability, CriteriaReadOnlyCollection criteria, bool dispellable, EffectArea effectArea, int min, int max)
