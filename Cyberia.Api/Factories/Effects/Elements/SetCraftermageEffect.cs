...
public sealed record SetCraftermageEffect
    : Effect, IEffect
{
    ...
    internal static SetCraftermageEffect Create(int effectId, EffectParameters parameters, int duration, int probability, CriteriaCollection criteria, EffectArea effectArea)
    {
