    ...
    : ParameterlessEffect, IEffect
{
    ...
    internal static CharacterUnluckyEffect Create(int effectId, EffectParameters _, int duration, int probability, CriteriaCollection criteria, EffectArea effectArea)
    {
