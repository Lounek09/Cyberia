...
public sealed record CharacterBoostEarthElementPercentEffect : MinMaxEffect, IRuneGeneratorEffect
{
    ...
    private CharacterBoostEarthElementPercentEffect(int id, int min, int max)
        : base(id, min, max) { }

    internal static CharacterBoostEarthElementPercentEffect Create(int effectId, EffectParameters parameters)
    {
