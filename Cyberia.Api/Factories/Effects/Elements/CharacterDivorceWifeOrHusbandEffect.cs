...
public sealed record CharacterDivorceWifeOrHusbandEffect : ParameterlessEffect, IEffect
{
    ...
    internal static CharacterDivorceWifeOrHusbandEffect Create(int effectId, EffectParameters _, int duration, int probability, CriteriaReadOnlyCollection criteria, EffectArea effectArea)
    {
