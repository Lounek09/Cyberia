...
public sealed record GotoWaypointEffect : ParameterlessEffect, IEffect
{
    ...
    internal static GotoWaypointEffect Create(int effectId, EffectParameters _, int duration, int probability, CriteriaReadOnlyCollection criteria, EffectArea effectArea)
    {
