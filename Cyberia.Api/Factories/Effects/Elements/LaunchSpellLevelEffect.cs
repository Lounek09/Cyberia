...
public sealed record LaunchSpellLevelEffect
    : Effect, IEffect
{
    ...
    internal static LaunchSpellLevelEffect Create(int effectId, EffectParameters parameters, int duration, int probability, CriteriaCollection criteria, EffectArea effectArea)
    {
