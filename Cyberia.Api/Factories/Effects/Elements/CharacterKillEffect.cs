...
public sealed record CharacterKillEffect : ParameterlessEffect
{
    ...
    internal static CharacterKillEffect Create(int effectId, EffectParameters _, int duration, int probability, CriteriaReadOnlyCollection criteria, EffectArea effectArea)
    {
