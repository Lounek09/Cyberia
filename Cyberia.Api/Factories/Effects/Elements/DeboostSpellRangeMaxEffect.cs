    ...
    : SpellModifierEffect, IEffect
{
    ...
    internal static DeboostSpellRangeMaxEffect Create(int effectId, EffectParameters parameters, int duration, int probability, CriteriaCollection criteria, EffectArea effectArea)
    {
