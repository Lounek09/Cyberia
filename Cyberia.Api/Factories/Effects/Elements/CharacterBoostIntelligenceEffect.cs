...
public sealed record CharacterBoostIntelligenceEffect : MinMaxEffect, IRuneGeneratorEffect
{
    ...
    private CharacterBoostIntelligenceEffect(int id, int min, int max)
        : base(id, min, max) { }

    internal static CharacterBoostIntelligenceEffect Create(int effectId, EffectParameters parameters)
    {
