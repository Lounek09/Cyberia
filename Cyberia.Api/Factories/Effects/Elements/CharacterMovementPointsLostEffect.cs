...
public sealed record CharacterMovementPointsLostEffect : MinMaxEffect
{
    ...
    internal static CharacterMovementPointsLostEffect Create(int effectId, EffectParameters parameters, int duration, int probability, CriteriaReadOnlyCollection criteria, EffectArea effectArea)
    {
