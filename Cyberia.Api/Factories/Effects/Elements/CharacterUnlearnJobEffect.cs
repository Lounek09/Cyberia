...
public sealed record CharacterUnlearnJobEffect
    : Effect, IEffect
{
    ...
    internal static CharacterUnlearnJobEffect Create(int effectId, EffectParameters parameters, int duration, int probability, CriteriaCollection criteria, EffectArea effectArea)
    {
