    ...
    : MinMaxEffect, IEffect
{
    ...
    internal static CharacterDeboostAgilityEffect Create(int effectId, EffectParameters parameters, int duration, int probability, CriteriaCollection criteria, EffectArea effectArea)
    {
