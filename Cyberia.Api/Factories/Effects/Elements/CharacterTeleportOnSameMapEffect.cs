...
public sealed record CharacterTeleportOnSameMapEffect
    : Effect, IEffect
{
    ...
    internal static CharacterTeleportOnSameMapEffect Create(int effectId, EffectParameters parameters, int duration, int probability, CriteriaCollection criteria, EffectArea effectArea)
    {
