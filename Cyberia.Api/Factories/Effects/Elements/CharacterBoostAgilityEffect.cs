    ...
    : MinMaxEffect, IEffect, IRuneGeneratorEffect
{
    ...
    internal static CharacterBoostAgilityEffect Create(int effectId, EffectParameters parameters, int duration, int probability, CriteriaCollection criteria, EffectArea effectArea)
    {
