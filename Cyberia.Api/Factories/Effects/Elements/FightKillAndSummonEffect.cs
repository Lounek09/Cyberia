...
public sealed record FightKillAndSummonEffect : Effect, IMonsterEffect
{
    ...
    private FightKillAndSummonEffect(int id, int monsterId, int grade)
        : base(id)
    {
        MonsterId = monsterId;
        Grade = grade;
    ...
    internal static FightKillAndSummonEffect Create(int effectId, EffectParameters parameters)
    {
