    ...
    : Effect, IEffect
{
    ...
    internal static CharacterChangeColorEffect Create(int effectId, EffectParameters parameters, int duration, int probability, CriteriaCollection criteria, EffectArea effectArea)
    {
