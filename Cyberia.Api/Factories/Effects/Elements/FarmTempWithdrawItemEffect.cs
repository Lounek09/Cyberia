    ...
    : ParameterlessEffect, IEffect
{
    ...
    internal static FarmTempWithdrawItemEffect Create(int effectId, EffectParameters _, int duration, int probability, CriteriaCollection criteria, EffectArea effectArea)
    {
