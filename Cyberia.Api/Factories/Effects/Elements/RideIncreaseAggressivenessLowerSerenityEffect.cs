...
public sealed record RideIncreaseAggressivenessLowerSerenityEffect : ParameterlessEffect
{
    ...
    internal static RideIncreaseAggressivenessLowerSerenityEffect Create(int effectId, EffectParameters _, int duration, int probability, CriteriaReadOnlyCollection criteria, EffectArea effectArea)
    {
