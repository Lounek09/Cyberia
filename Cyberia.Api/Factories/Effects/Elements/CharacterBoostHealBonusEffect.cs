...
public sealed record CharacterBoostHealBonusEffect : MinMaxEffect, IRuneGeneratorEffect
{
    ...
    private CharacterBoostHealBonusEffect(int id, int min, int max)
        : base(id, min, max) { }

    internal static CharacterBoostHealBonusEffect Create(int effectId, EffectParameters parameters)
    {
