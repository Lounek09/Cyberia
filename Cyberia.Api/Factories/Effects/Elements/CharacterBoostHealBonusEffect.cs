...
public sealed record CharacterBoostHealBonusEffect
    : MinMaxEffect, IEffect, IRuneGeneratorEffect
{
    ...
    internal static CharacterBoostHealBonusEffect Create(int effectId, EffectParameters parameters, int duration, int probability, CriteriaCollection criteria, EffectArea effectArea)
    {
