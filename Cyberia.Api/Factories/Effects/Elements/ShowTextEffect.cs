...
public sealed record ShowTextEffect
    : Effect, IEffect
{
    ...
    internal static ShowTextEffect Create(int effectId, EffectParameters parameters, int duration, int probability, CriteriaCollection criteria, EffectArea effectArea)
    {
