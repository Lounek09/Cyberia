    ...
    : Effect, IEffect
{
    ...
    internal static CharacterMultiplyReceivedDamageOrGiveLifeWithRatioEffect Create(int effectId, EffectParameters parameters, int duration, int probability, CriteriaCollection criteria, EffectArea effectArea)
    {
