    ...
    : ParameterlessEffect, IEffect
{
    ...
    internal static FarmWithdrawItemEffect Create(int effectId, EffectParameters _, int duration, int probability, CriteriaCollection criteria, EffectArea effectArea)
    {
