...
public sealed record ItemCurrentSoulEaterEffect : ParameterlessEffect
{
    ...
    internal static ItemCurrentSoulEaterEffect Create(int effectId, EffectParameters _, int duration, int probability, CriteriaReadOnlyCollection criteria, EffectArea effectArea)
    {
