...
{
    public sealed record GiveRideAbilityEffect : BasicEffect
    {
        ...
        public static new GiveRideAbilityEffect Create(int effectId, EffectParameters parameters, int duration, int probability, string criteria, Area area)
        {
