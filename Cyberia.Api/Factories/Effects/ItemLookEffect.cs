...
namespace Cyberia.Api.Factories.Effects
{
    public sealed class ItemLookEffect : BasicEffect
    {
        ...
        public ItemLookEffect(int effectId, EffectParameters parameters, int duration, int probability, Area area) : 
            base(effectId, parameters, duration, probability, area)
        {
            ItemId = parameters.Param3;
        }

        public static new ItemLookEffect Create(int effectId, EffectParameters parameters, int duration, int probability, Area area)
        {
