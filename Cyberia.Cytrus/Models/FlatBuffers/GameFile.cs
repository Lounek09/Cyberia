...
namespace Cyberia.Cytrus.Models.FlatBuffers
{
    ...
    public struct GameFile : IFlatbufferObject
    {
        ...
        public Cyberia.Cytrus.Models.FlatBuffers.Chunk? Chunks(int j) { int o = __p.__offset(10); return o != 0 ? (Cyberia.Cytrus.Models.FlatBuffers.Chunk?)(new Cyberia.Cytrus.Models.FlatBuffers.Chunk()).__assign(__p.__indirect(__p.__vector(o) + j * 4), __p.bb) : null; }
        ...
        public static Offset<Cyberia.Cytrus.Models.FlatBuffers.GameFile> CreateFile(FlatBufferBuilder builder,
        ...
        public static VectorOffset CreateChunksVector(FlatBufferBuilder builder, Offset<Cyberia.Cytrus.Models.FlatBuffers.Chunk>[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddOffset(data[i].Value); return builder.EndVector(); }
        public static VectorOffset CreateChunksVectorBlock(FlatBufferBuilder builder, Offset<Cyberia.Cytrus.Models.FlatBuffers.Chunk>[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
        public static VectorOffset CreateChunksVectorBlock(FlatBufferBuilder builder, ArraySegment<Offset<Cyberia.Cytrus.Models.FlatBuffers.Chunk>> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
        public static VectorOffset CreateChunksVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Offset<Cyberia.Cytrus.Models.FlatBuffers.Chunk>>(dataPtr, sizeInBytes); return builder.EndVector(); }
        ...
        public static Offset<Cyberia.Cytrus.Models.FlatBuffers.GameFile> EndFile(FlatBufferBuilder builder) {
            int o = builder.EndTable();
            return new Offset<Cyberia.Cytrus.Models.FlatBuffers.GameFile>(o);
        }
    }
}
