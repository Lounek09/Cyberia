...
| `Type`               | The type of lang loaded at startup                                                                            | [LangType](Libs/Cyberia.Langzilla.Primitives/LangType.cs) |
| `BaseLanguage`       | The language of lang from which the base data is loaded, only the translations will be loaded from the others | [Language](Libs/Cyberia.Langzilla.Primitives/Language.cs) |
| `SupportedLanguages` | The list of the supported languages, the first one will be the default language.                              | [Language](Libs/Cyberia.Langzilla.Primitives/Language.cs)[] |
