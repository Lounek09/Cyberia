...
public struct Chunk : IFlatbufferObject
{
  ...
  public static Offset<Cyberia.Cytrusaurus.Models.FlatBuffers.Chunk> CreateChunk(FlatBufferBuilder builder,
  ...
  public static Offset<Cyberia.Cytrusaurus.Models.FlatBuffers.Chunk> EndChunk(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Cyberia.Cytrusaurus.Models.FlatBuffers.Chunk>(o);
  }
}


static public class ChunkVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*Offset*/, 8 /*long*/, 8, false)
