/*
 * This file include methods originated from https://github.com/apache/lucenenet,
 * specifically from https://github.com/apache/lucenenet/blob/master/src/Lucene.Net.Analysis.Common/Analysis/Miscellaneous/ASCIIFoldingFilter.cs
 * 
...
public static partial class StringExtensions
{
    ...
    /// </remarks>
    public static string NormalizeToAscii(this string value)
    {
        return NormalizeToAscii(value.AsSpan());
    }

    /// <inheritdoc cref="NormalizeToAscii(string)"/>
    public static string NormalizeToAscii(this ReadOnlySpan<char> value)
    {
        s_builder.Clear();
        ...
        for (var i = 0; i < length; i++)
        {
            ...
            switch (c)
            {
                ...
                case '\uFB03': // ﬃ  [LATIN SMALL LIGATURE FFI]
                    s_builder.Append("ffi");
                    break;
                case '\uFB04': // ﬄ  [LATIN SMALL LIGATURE FFL]
                    s_builder.Append("ffl");
                    break;
