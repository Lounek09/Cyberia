...
public sealed class SpellInteractionLocalizer : InteractionLocalizer
{
    public const string CommandName = "spell";
    public const string CommandDescription = "Return the information of a spell from its name.";

    public const string Value_ParameterName = "name";
    public const string Value_ParameterDescription = "Name of the spell.";
    ...
    protected override IReadOnlyDictionary<DiscordLocale, string> InternalTranslate(string fullSymbolName)
    {
        ...
        if (fullSymbolName.Equals(CommandName + c_description))
        {
            return new Dictionary<DiscordLocale, string>
            {
                ...
                { DiscordLocale.fr, "Retourne les informations d'un sort à partir de son nom." }
            };
        }
