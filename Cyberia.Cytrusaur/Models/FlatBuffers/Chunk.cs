...
namespace Cyberia.Cytrusaur.Models.FlatBuffers
{
    ...
    public struct Chunk : IFlatbufferObject
    {
        ...
        public static Offset<Cyberia.Cytrusaur.Models.FlatBuffers.Chunk> CreateChunk(FlatBufferBuilder builder,
        ...
        public static Offset<Cyberia.Cytrusaur.Models.FlatBuffers.Chunk> EndChunk(FlatBufferBuilder builder) {
            int o = builder.EndTable();
            return new Offset<Cyberia.Cytrusaur.Models.FlatBuffers.Chunk>(o);
        }
    }
}
