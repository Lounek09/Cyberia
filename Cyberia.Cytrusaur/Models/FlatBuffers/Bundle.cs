...
namespace Cyberia.Cytrusaur.Models.FlatBuffers
{
    ...
    public struct Bundle : IFlatbufferObject
    {
        ...
        public Cyberia.Cytrusaur.Models.FlatBuffers.Chunk? Chunks(int j) { int o = __p.__offset(6); return o != 0 ? (Cyberia.Cytrusaur.Models.FlatBuffers.Chunk?)(new Cyberia.Cytrusaur.Models.FlatBuffers.Chunk()).__assign(__p.__indirect(__p.__vector(o) + j * 4), __p.bb) : null; }
        public int ChunksLength { get { int o = __p.__offset(6); return o != 0 ? __p.__vector_len(o) : 0; } }

        public static Offset<Cyberia.Cytrusaur.Models.FlatBuffers.Bundle> CreateBundle(FlatBufferBuilder builder,
        ...
        public static Offset<Cyberia.Cytrusaur.Models.FlatBuffers.Bundle> EndBundle(FlatBufferBuilder builder) {
            int o = builder.EndTable();
            return new Offset<Cyberia.Cytrusaur.Models.FlatBuffers.Bundle>(o);
        }
    }
}
