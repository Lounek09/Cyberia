...
namespace Cyberia.Cytrusaur.Models.FlatBuffers
{
    ...
    public struct Manifest : IFlatbufferObject
    {
        ...
        public Cyberia.Cytrusaur.Models.FlatBuffers.Fragment? Fragments(int j) { int o = __p.__offset(4); return o != 0 ? (Cyberia.Cytrusaur.Models.FlatBuffers.Fragment?)(new Cyberia.Cytrusaur.Models.FlatBuffers.Fragment()).__assign(__p.__indirect(__p.__vector(o) + j * 4), __p.bb) : null; }
        public int FragmentsLength { get { int o = __p.__offset(4); return o != 0 ? __p.__vector_len(o) : 0; } }

        public static Offset<Cyberia.Cytrusaur.Models.FlatBuffers.Manifest> CreateManifest(FlatBufferBuilder builder,
        ...
        public static VectorOffset CreateFragmentsVector(FlatBufferBuilder builder, Offset<Cyberia.Cytrusaur.Models.FlatBuffers.Fragment>[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddOffset(data[i].Value); return builder.EndVector(); }
        public static VectorOffset CreateFragmentsVectorBlock(FlatBufferBuilder builder, Offset<Cyberia.Cytrusaur.Models.FlatBuffers.Fragment>[] data) { builder.StartVector(4, data.Length, 4); builder.Add(data); return builder.EndVector(); }
        public static VectorOffset CreateFragmentsVectorBlock(FlatBufferBuilder builder, ArraySegment<Offset<Cyberia.Cytrusaur.Models.FlatBuffers.Fragment>> data) { builder.StartVector(4, data.Count, 4); builder.Add(data); return builder.EndVector(); }
        public static VectorOffset CreateFragmentsVectorBlock(FlatBufferBuilder builder, IntPtr dataPtr, int sizeInBytes) { builder.StartVector(1, sizeInBytes, 1); builder.Add<Offset<Cyberia.Cytrusaur.Models.FlatBuffers.Fragment>>(dataPtr, sizeInBytes); return builder.EndVector(); }
        public static void StartFragmentsVector(FlatBufferBuilder builder, int numElems) { builder.StartVector(4, numElems, 4); }
        public static Offset<Cyberia.Cytrusaur.Models.FlatBuffers.Manifest> EndManifest(FlatBufferBuilder builder) {
            int o = builder.EndTable();
            return new Offset<Cyberia.Cytrusaur.Models.FlatBuffers.Manifest>(o);
        }
        public static void FinishManifestBuffer(FlatBufferBuilder builder, Offset<Cyberia.Cytrusaur.Models.FlatBuffers.Manifest> offset) { builder.Finish(offset.Value); }
        public static void FinishSizePrefixedManifestBuffer(FlatBufferBuilder builder, Offset<Cyberia.Cytrusaur.Models.FlatBuffers.Manifest> offset) { builder.FinishSizePrefixed(offset.Value); }
