...
namespace Salamandra.Cytrus.Models.FlatBuffers
{
    ...
    public struct Bundle : IFlatbufferObject
    {
        ...
        public Salamandra.Cytrus.Models.FlatBuffers.Chunk? Chunks(int j) { int o = __p.__offset(6); return o != 0 ? (Salamandra.Cytrus.Models.FlatBuffers.Chunk?)(new Salamandra.Cytrus.Models.FlatBuffers.Chunk()).__assign(__p.__indirect(__p.__vector(o) + j * 4), __p.bb) : null; }
        public int ChunksLength { get { int o = __p.__offset(6); return o != 0 ? __p.__vector_len(o) : 0; } }

        public static Offset<Salamandra.Cytrus.Models.FlatBuffers.Bundle> CreateBundle(FlatBufferBuilder builder,
        ...
        public static Offset<Salamandra.Cytrus.Models.FlatBuffers.Bundle> EndBundle(FlatBufferBuilder builder) {
            int o = builder.EndTable();
            return new Offset<Salamandra.Cytrus.Models.FlatBuffers.Bundle>(o);
        }
    }
}
