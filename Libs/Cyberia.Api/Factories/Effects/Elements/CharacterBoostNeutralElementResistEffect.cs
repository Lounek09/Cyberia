...
{
    public Rune Rune => Rune.NeutralRe;

    private CharacterBoostNeutralElementResistEffect(int id, int min, int max)
        : base(id, min, max) { }

    internal static CharacterBoostNeutralElementResistEffect Create(int effectId, EffectParameters parameters)
    {
