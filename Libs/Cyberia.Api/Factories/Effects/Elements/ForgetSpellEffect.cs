...
public sealed record ForgetSpellEffect : Effect, ISpellEffect
{
    public int SpellId { get; init; }

    private ForgetSpellEffect(int id, int spellId)
        : base(id)
    {
        SpellId = spellId;
    }

    internal static ForgetSpellEffect Create(int effectId, EffectParameters parameters)
    {
