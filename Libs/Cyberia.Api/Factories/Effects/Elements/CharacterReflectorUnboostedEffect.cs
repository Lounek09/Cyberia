...
{
    public Rune Rune => Rune.DoRen;

    private CharacterReflectorUnboostedEffect(int id, int min, int max)
        : base(id, min, max) { }

    internal static CharacterReflectorUnboostedEffect Create(int effectId, EffectParameters parameters)
    {
