...
public sealed record CharacterBoostDealtAndReceivedDamagePercentMultiplierEffect : Effect
{
    ...
    private CharacterBoostDealtAndReceivedDamagePercentMultiplierEffect(int id, int minDealtDamagePercent, int minReceivedDamagePercent, int maxDealtDamagePercent, int maxReceivedDamagePercent)
        : base(id)
    {
    ...
    internal static CharacterBoostDealtAndReceivedDamagePercentMultiplierEffect Create(int effectId, EffectParameters parameters)
    {
        ...
        return new(effectId, param1, param2, param3, param4);
    }
