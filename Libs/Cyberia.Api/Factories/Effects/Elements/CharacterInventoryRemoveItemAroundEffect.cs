...
public sealed record CharacterInventoryRemoveItemAroundEffect : Effect, IItemEffect
{
    public int ItemId { get; init; }
    public int Quantity { get; init; }

    private CharacterInventoryRemoveItemAroundEffect(int id, int itemId, int quantity)
        : base(id)
    {
        ItemId = itemId;
        Quantity = quantity;
    ...
    internal static CharacterInventoryRemoveItemAroundEffect Create(int effectId, EffectParameters parameters)
    {
