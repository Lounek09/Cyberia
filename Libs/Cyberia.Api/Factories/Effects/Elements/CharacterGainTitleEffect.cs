...
public sealed record CharacterGainTitleEffect : Effect, ITitileEffect
{
    public int TitleId { get; init; }

    private CharacterGainTitleEffect(int id, int titleId)
        : base(id)
    {
        TitleId = titleId;
    }

    internal static CharacterGainTitleEffect Create(int effectId, EffectParameters parameters)
    {
