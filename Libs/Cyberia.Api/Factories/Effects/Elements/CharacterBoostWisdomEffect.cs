...
{
    public Rune Rune => Rune.Sa;

    private CharacterBoostWisdomEffect(int id, int min, int max)
        : base(id, min, max) { }

    internal static CharacterBoostWisdomEffect Create(int effectId, EffectParameters parameters)
    {
