...
{
    public Rune Rune => Rune.GaPa;

    private CharacterBoostActionPointsEffect(int id, int min, int max)
        : base(id, min, max) { }

    internal static CharacterBoostActionPointsEffect Create(int effectId, EffectParameters parameters)
    {
