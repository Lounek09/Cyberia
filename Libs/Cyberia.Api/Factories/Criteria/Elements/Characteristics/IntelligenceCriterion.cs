...
public sealed record IntelligenceCriterion : Criterion
{
    public int Value { get; init; }

    private IntelligenceCriterion(string id, char @operator, int value)
        : base(id, @operator)
    {
        Value = value;
    }

    internal static IntelligenceCriterion? Create(string id, char @operator, params ReadOnlySpan<string> parameters)
    {
