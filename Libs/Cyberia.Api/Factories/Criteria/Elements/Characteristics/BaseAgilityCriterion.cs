...
public sealed record BaseAgilityCriterion : Criterion
{
    ...
    private BaseAgilityCriterion(string id, char @operator, int value, bool isScroll)
        : base(id, @operator)
    {
        Value = value;
        IsScroll = isScroll;
    ...
    internal static BaseAgilityCriterion? Create(string id, char @operator, params ReadOnlySpan<string> parameters)
    {
