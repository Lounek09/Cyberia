...
public sealed record WisdomCriterion : Criterion
{
    ...
    internal static WisdomCriterion? Create(string id, char @operator, params ReadOnlySpan<string> parameters)
    {
    ...
    {
        return $"Criterion.Wisdom.{GetOperatorDescriptionKey()}";
    }
