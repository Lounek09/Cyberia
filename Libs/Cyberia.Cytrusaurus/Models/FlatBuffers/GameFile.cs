...
public struct GameFile : IFlatbufferObject
{
  ...
  public static GameFile GetRootAsGameFile(ByteBuffer _bb) { return GetRootAsGameFile(_bb, new GameFile()); }
  public static GameFile GetRootAsGameFile(ByteBuffer _bb, GameFile obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  ...
  public Cyberia.Cytrusaurus.Models.FlatBuffers.Chunk? Chunks(int j) { int o = __p.__offset(10); return o != 0 ? (Cyberia.Cytrusaurus.Models.FlatBuffers.Chunk?)(new Cyberia.Cytrusaurus.Models.FlatBuffers.Chunk()).__assign(__p.__indirect(__p.__vector(o) + j * 4), __p.bb) : null; }
  ...
  public static Offset<Cyberia.Cytrusaurus.Models.FlatBuffers.GameFile> CreateGameFile(FlatBufferBuilder builder,
    ...
    return GameFile.EndGameFile(builder);
  }

  public static void StartGameFile(FlatBufferBuilder builder) { builder.StartTable(6); }
  ...
  public static Offset<Cyberia.Cytrusaurus.Models.FlatBuffers.GameFile> EndGameFile(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<Cyberia.Cytrusaurus.Models.FlatBuffers.GameFile>(o);
  }
}


static public class GameFileVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      && verifier.VerifyString(tablePos, 4 /*Name*/, false)
      && verifier.VerifyField(tablePos, 6 /*Size*/, 8 /*long*/, 8, false)
      && verifier.VerifyVectorOfData(tablePos, 8 /*Hash*/, 1 /*sbyte*/, false)
      && verifier.VerifyVectorOfTables(tablePos, 10 /*Chunks*/, Cyberia.Cytrusaurus.Models.FlatBuffers.ChunkVerify.Verify, false)
      && verifier.VerifyField(tablePos, 12 /*Executable*/, 1 /*bool*/, 1, false)
      && verifier.VerifyString(tablePos, 14 /*Symlink*/, false)
